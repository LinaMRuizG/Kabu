...
if __name__ == "__main__":
    ...
    test = detectingPeaksValleys(databasePath,datesName,casesName,kernel,thresholdW,thresholdPV)
    ...
    test.idenCutPointsidenCutPoints("rollingFDS","FirstDerivateSmoothed")
