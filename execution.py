...
if __name__ == "__main__":
    ...
    database = pd.read_csv("/Users/linaruiz/Documents/EpidemicKabu_project/EpidemicKabu/exampleUseLibrary/data/databaseExampleItaly.csv")
    datesName = "Date_reported"
    casesName = "New_cases"
    kernel = 28
    plotName = "Epidemic_curve_Belgica_"
    dfName = "Epidemic_curve_Belgica_"
